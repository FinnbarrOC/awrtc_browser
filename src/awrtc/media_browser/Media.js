...
var VideoInput_1 = require("./VideoInput");
var Media = /** @class */ (function () {
    ...
    Object.defineProperty(Media.prototype, "VideoInput", {
        get: function () {
            if (this.videoInput === null)
                this.videoInput = new VideoInput_1.VideoInput();
    ...
    Media.prototype.GetVideoDevices = function () {
        var real_devices = DeviceApi_1.DeviceApi.GetVideoDevices();
    ...
    Media.prototype.getUserMedia = function (config) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, DeviceApi_1.DeviceApi.getBrowserUserMedia(constraints)];
                        case 1:
        ...
        return DeviceApi_1.DeviceApi.getAssetUserMedia(config);
    };
