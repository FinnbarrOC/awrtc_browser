...
exports.ExtractData = exports.MakeTestImage = exports.MakeBrokenTestCanvas = exports.MakeTestCanvas = exports.VideoInputTest_export = void 0;
var index_1 = require("../awrtc/index");
function VideoInputTest_export() {
}
exports.VideoInputTest_export = VideoInputTest_export;
...
exports.MakeTestCanvas = MakeTestCanvas;
function MakeBrokenTestCanvas() {
    var canvas = document.createElement("canvas");
    return canvas;
}
exports.MakeBrokenTestCanvas = MakeBrokenTestCanvas;
...
exports.MakeTestImage = MakeTestImage;
...
describe("VideoInputTest", function () {
    ...
    it("Device_int_array", function () {
        ...
        var res = vi.UpdateFrame(name, clamped, w, h, index_1.VideoInputType.ARGB, 0, false);
    ...
    it("Device_full", function () {
        ...
        var stream = vi.GetStream(name);
        expect(stream).toBeTruthy();
        var res = vi.UpdateFrame(name, src_img.data, src_img.width, src_img.height, index_1.VideoInputType.ARGB, 0, false);
        expect(res).toBe(true);
