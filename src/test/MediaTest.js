...
exports.MediaTest_export = void 0;
var index_1 = require("../awrtc/index");
var VideoInputTest_1 = require("VideoInputTest");
function MediaTest_export() {
}
exports.MediaTest_export = MediaTest_export;
describe("MediaTest", function () {
    beforeEach(function (done) {
        var handler = function () {
            index_1.DeviceApi.RemOnChangedHandler(handler);
            done();
        };
        index_1.DeviceApi.AddOnChangedHandler(handler);
        index_1.DeviceApi.Update();
        index_1.Media.ResetSharedInstance();
    });
    it("SharedInstance", function () {
        expect(index_1.Media.SharedInstance).toBeTruthy();
        var instance1 = index_1.Media.SharedInstance;
        index_1.Media.ResetSharedInstance();
        expect(index_1.Media.SharedInstance).not.toBe(instance1);
    });
    it("GetVideoDevices", function () {
        var media = new index_1.Media();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    config.Audio = false;
                    config.Video = true;
                    canvas = VideoInputTest_1.MakeTestCanvas();
    ...
    it("MediaCapiVideoInput", function (done) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            expect(index_1.CAPI_Media_GetVideoDevices_Length()).toBe(0);
            name = "test_canvas";
            canvas = VideoInputTest_1.MakeTestCanvas();
            index_1.Media.SharedInstance.VideoInput.AddCanvasDevice(canvas, name, canvas.width, canvas.height, 30);
            expect(index_1.CAPI_Media_GetVideoDevices_Length()).toBe(1);
            expect(index_1.CAPI_Media_GetVideoDevices(0)).toBe(name);
            done();
            return [2 /*return*/];
        });
    }); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    stream = new index_1.BrowserMediaStream(testcontainer.stream);
